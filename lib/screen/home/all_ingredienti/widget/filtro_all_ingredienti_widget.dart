...
class FiltroAllIngredientiWidget extends StatefulWidget {
  ...
  @override
  State<FiltroAllIngredientiWidget> createState() => _FiltroAllIngredientiWidgetState();
}

class _FiltroAllIngredientiWidgetState extends State<FiltroAllIngredientiWidget> {
  ...
  @override
  void initState() {
    // Provider.of<HomeProvider>(context, listen: false).resetFiltroIngredienti();
    super.initState();
